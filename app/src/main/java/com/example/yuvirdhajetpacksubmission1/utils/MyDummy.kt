...
object MyDummy {
    ...
    fun generateDummyTvShows(): ArrayList<DataTvShowEntity> {

        val dummyTvShows = ArrayList<DataTvShowEntity>()

        dummyTvShows.add(DataTvShowEntity(
                "Breaking Bad",
                "2008-2013",
                "Crime | Thriller",
    ...
    fun generateRemoteDummyTvShows(): ArrayList<DataTvShowEntityResponse> {

        val dummyTvShows = ArrayList<DataTvShowEntityResponse>()

        dummyTvShows.add(DataTvShowEntityResponse(
                "Breaking Bad",
                "2008-2013",
                "Crime | Thriller",
                "A high school chemistry teacher diagnosed with inoperable lung cancer turns to manufacturing and selling methamphetamine in order to secure his family's future.",
    ...
    fun generateDetailMovies(title: String): ArrayList<DataMovieEntity> {
    ...
    fun generateDetailTvShows(title: String): ArrayList<DataTvShowEntity> {
    ...
    fun generateDetailFavMovies(movies: DataMovieEntity, isFav: Boolean): DataMovieDetailEntity {
        movies.isFav = isFav
        return DataMovieDetailEntity(movies, generateDetailMovies(movies.title))
    }

    fun generateDetailFavTvShows(movies: DataTvShowEntity, isFav: Boolean): DataTvShowDetailEntity {
        movies.isFav = isFav
        return DataTvShowDetailEntity(movies, generateDetailTvShows(movies.title))
    }
