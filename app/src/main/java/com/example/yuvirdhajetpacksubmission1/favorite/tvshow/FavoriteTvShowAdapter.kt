...
class FavoriteTvShowAdapter: PagedListAdapter<DataTvShowEntity, FavoriteTvShowAdapter.FavoriteTvShowViewHolder>(DIFF_CALLBACK) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FavoriteTvShowViewHolder {
        ...
        return FavoriteTvShowViewHolder(itemListBinding)
    }
    ...
    fun getSwipedData(swipedPosition: Int): DataTvShowEntity? = getItem(swipedPosition)


    class FavoriteTvShowViewHolder(private val binding: ItemListBinding) : RecyclerView.ViewHolder(binding.root) {
